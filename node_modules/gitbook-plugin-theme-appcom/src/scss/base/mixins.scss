@mixin gitbook-markdown( $md-color: #000, $md-line-height: 1.7, $md-link-color: #84AFAB, $md-code-background: #f7f7f7, $md-code-fontsize: 0.85, $md-blockquote-color: #858585, $md-blockquote-border: #e5e5e5, $md-h6-color: #777) {
    // Rate of growth for headings
    $scale: 0.25; // Spacing between blocks
    ...
    * {
    ...
    .tags {
        ...
        a {
            font-size: 1.3rem;
            border-radius: 3px;
            border: 1px solid $md-link-color !important;
            &:hover {
                background-color: $md-link-color !important;
            }
        }
    }
    /* Images */
    ...
    code {
        padding: 0.2em;
        margin: 0;
        font-size: $md-code-fontsize * 1.5em;
